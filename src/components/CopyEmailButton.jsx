...
const CopyEmailButton = () => {
	...
	const email = "sadiaurooj258@gmail.com";
	...
	return (
		<motion.button onClick={copyToClipboard}
			...
			<AnimatePresence mode="wait">
				{
				copied ? (
					<motion.p className="flex items-center justify-center gap-2" key="copied"
						initial={
							{
								opacity: 0,
								y: -10
					...
					<motion.p className="flex items-center justify-center gap-2" key="copy"
						initial={
							{opacity: 0}
						}
						animate={
